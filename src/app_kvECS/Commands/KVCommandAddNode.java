...
public class KVCommandAddNode extends KVCommand<ECSClient> {
    ...
    public KVJSONMessage execute(ECSClient clientInstance) {
        ...
        clientInstance.addNode(getCacheStrategy(),getCacheSize());
    ...
    public void setPortNumber(int portNumber) {set("PortNumber",Integer.toString(portNumber));}
    public int getPortNumber(){return Integer.parseInt(getValue("PortNumber"));}
    public void setCacheSize(int cacheSize) { set("CacheSize",Integer.toString(cacheSize)); }
    public void setCacheStrategy(String cacheStrategy) { set("CacheStrategy",cacheStrategy); }
    public int getCacheSize() { return Integer.parseInt(getValue("CacheSize")); }
