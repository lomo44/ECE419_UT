...
public class KVMetadataControllerTests extends TestCase{
    ...
    public void testKVMetadataController_Map() throws Exception {
        controller.addStorageNode(new KVStorageNode("010",001));
        //37A33999994C8F95880620D477BC313E
        controller.addStorageNode(new KVStorageNode("78999",567));
        ...
        KVNetworkNode id = controller.getResponsibleStorageNode(hash);
